...
molsys=DR.MolSys('/mnt/c/Users/thier/Desktop/1ubq_frame.pdb',
                 '/mnt/c/Users/thier/Desktop/comb_md_PBC_skip_fit.xtc',
                 tf=tf)
...
select.select_bond(Nuc='ivlal')   #Select 1 methyl group from all isoleucine, valine, leucine, and alanine residues
